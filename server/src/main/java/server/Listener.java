...
public class Listener {
    ...
    public void start() throws IOException, InterruptedException {
        System.out.println("Сервер стартанул. Ждем соединения...");
        try (ServerSocket server = new ServerSocket(port)) {
            ...
            while (!client.isClosed()) {
                ...
                Logics.countUp(entry);
                String answer = "Процент строчных букв: "+Logics.getPercentLowerCase()+
                                "\nПроцент прописных букв: "+ Logics.getPercentUpperCase();
